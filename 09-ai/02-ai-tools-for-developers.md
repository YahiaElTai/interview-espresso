...
> **19 questions** — 12 theory, 7 practical
...
<details>
<summary>11. Given a set of engineering tasks -- greenfield feature development, large-scale refactoring, debugging a production issue, and exploring an unfamiliar codebase -- which AI tool would you reach for in each case, why, and what factors should drive a team's choice of primary AI tool vs allowing individual choice?</summary>
...
<details>
<summary>17. Tell me about a time an AI tool generated code that looked correct but had a subtle bug or security issue that made it to review or production — how did you discover it, what was the impact, and what review practices did you change as a result?</summary>
...
<details>
<summary>18. Describe a time you used an AI tool to significantly speed up a complex engineering task — what was the task, how did you use the tool (prompting strategy, iteration), and where did you have to take over manually? What would the task have looked like without the AI tool?</summary>
...
<details>
<summary>19. Describe a time you had to debug an issue that an AI tool couldn't help with -- or worse, sent you in the wrong direction -- what was the problem, why did the AI tool fail, and how did you ultimately solve it?</summary>
