...
> **28 questions** — 13 theory, 11 practical, 4 experience
...
<details>
<summary>12. What makes a blameless postmortem effective vs a checkbox exercise — why does the timeline format matter, how do you distinguish root cause from contributing factors, what makes action items actually get completed (owners, deadlines, tracking), and how do you build a culture where postmortems lead to systemic improvements rather than finger-pointing or filing tickets that never get prioritized?</summary>
...
<details>
<summary>13. What are the common categories of Kubernetes networking failures and why are they hard to debug — how do DNS resolution failures, endpoint registration delays, network policy misconfigurations, and kube-proxy/iptables rule issues each manifest differently, and why does "the pod is running but can't be reached" have so many possible root causes?</summary>
...
<details>
<summary>25. Tell me about a time you debugged a production issue that couldn't be reproduced in staging or locally — what made it production-specific, how did you approach the investigation without full local reproducibility, and what did you change about your debugging or deployment process afterward?</summary>
...
<details>
<summary>26. Describe a time you led or participated in an incident response and the subsequent postmortem — what was the incident, how was it triaged and mitigated, what did the postmortem reveal as root cause vs contributing factors, and did the action items actually get implemented?</summary>
...
<details>
<summary>27. Tell me about a time you improved debugging or observability tooling for your team — what gap did you identify (missing traces, poor log structure, no correlation IDs), what did you implement, and how did it measurably improve incident response or debugging speed?</summary>
...
<details>
<summary>28. Describe a time you diagnosed a distributed system failure where the root cause was far from the symptoms — how did you trace from the user-visible impact back through multiple services to find the actual broken component, and what made the investigation difficult?</summary>
